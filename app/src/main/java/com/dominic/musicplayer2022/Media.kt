...
import kotlinx.android.synthetic.main.fragment_media2.view.*
...
class Media : Fragment() {
    ...
    override fun onCreateView(
        ...
        root = inflater.inflate(R.layout.fragment_media2, container, false)
    ...
    override fun onResume() {
        ...
        if (position!=-1) {
            ...
            mediaPlayer?.start()
            //   root.music_pause.background = resources.getDrawable(R.drawable.w)
            ...
            if (MyData.list[position].imagePath!=""){
                ...
                root.image_music.setImageBitmap(bm)
            }
        ...
        root.btn_pause.setOnClickListener {
            if (mediaPlayer?.isPlaying!!){
                mediaPlayer?.pause()
                root.btn_pause.background = resources.getDrawable(R.drawable.ic_play_circle)
            }else{
                mediaPlayer?.start()
                root.btn_pause.background = resources.getDrawable(R.drawable.ic_pause_circle_outline)
            }
        }
